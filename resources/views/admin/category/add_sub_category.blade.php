...
<form class="forms-sample" action="{{route('subcategories.store')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="sub_category">
  </div>
  <div class="form-group">
            <label for="exampleInputEmail4">Description</label>
            <textarea class="form-control" id="exampleInputEmail4" placeholder="Description" name="desc"></textarea>
        </div>
  <div class="form-group">
