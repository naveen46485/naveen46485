          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="{{route('subcategories.create')}}">Add Subcategory</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('subcategories.index')}}">Subcategory List</a></li>
                ...
                <li class="nav-item"> <a class="nav-link" href="{{route('sliders.create')}}">Add sliders</a></li>
              </ul>
            </div>
          </li>
